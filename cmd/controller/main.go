...
import (
	...
	"github.com/crashappsec/chalkular/internal/controller"
	webhookv1beta1 "github.com/crashappsec/chalkular/internal/webhook/v1beta1"
...
func init() {
	...
	utilruntime.Must(chalkularocularcrashoverriderunv1beta1.AddToScheme(scheme))
	utilruntime.Must(ocularv1beta1.AddToScheme(scheme))
